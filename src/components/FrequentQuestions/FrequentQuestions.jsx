  ...
  return (
    <div className="w-full bg-quest-image  lg:h-[1121px] mx-auto rounded-[16px]">
      <div className="w-full h-full  bg-[#00000066] px-[20px] py-[40px] lg:py-[64px] lg:px-[72px] rounded-[16px] ">
        ...
        <div className="lg:h-[48px] bg-white gap-4 h-[152px] flex flex-col lg:flex-row justify-between w-full  ">
              ...
              <div className="z-50 xl:w-[150px] lg:w-[150px] w-[134px] h-[44px]  pl-[12px] lg:h-[48px] lg:pl-[12px] lg:pr-[4px] rounded-[100px] flex justify-between items-center text-white font-medium bg-[#0550A1] text-[13px] md:text-[14px] xl:text-[16px] shadow-md hover:shadow-2xl transition-all duration-300 ease-in-out group">
                Contact Us
                <Link href="">
