        ...
        <div className="lg:h-[584px]  lg:w-full  h-[608px] bg-transparent p-[16px] flex flex-col justify-between ">
          ...
          <div className="lg:w-full lg:h-[132px] h-[228px]  lg:mt-[280px] bg-transparent">
            ...
            <div className="lg:h-[48px] h-[152px] flex flex-col lg:flex-row justify-between w-full bg-transparent mt-[20px]">
              ...
              <div className="lg:w-[150px] w-[134px] h-[44px] p-[4px] pb-[4px] pl-[12px] lg:h-[48px] lg:py-[12px] lg:pl-[12px] lg:pr-[4px] lg:pb-[12px] rounded-[100px] flex justify-between items-center text-[#171717]  bg-white">Contact Us
