      ...
      <div className="py-[8px] px-[20px] lg:py-[32px] lg:px-[72px] lg:h-[728px] flex flex-col gap-[8px]">
        <div className="flex flex-col gap-[20px] lg:gap-[24px] lg:h-[664px]">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-center gap-[16px] lg:gap-[24px]">
            <div className="w-full h-[320px] lg:w-[546px] xl:w-[746px] object-cover rounded-[16px]">
              <Image
                className="w-full h-[320px] lg:w-[546px] xl:w-[746px] object-cover rounded-[16px]"
                src={project.pimage1}
                alt="alt"
                width={546}
                height={320}
            ...
            <div className="w-full h-[320px] lg:w-[348px] xl:w-[528px] object-cover rounded-[16px]">
              <Image
                className="w-full h-[320px] lg:w-[348px] xl:w-[528px] object-cover rounded-[16px]"
                src={project.pimage2}
                alt="alt"
                width={546}
                height={320}
          ...
          <div className="grid grid-cols-1 lg:flex gap-[16px] lg:gap-[14px] xl:gap-[24px] justify-center">
            <div className="w-full h-[320px] lg:w-[285px] xl:w-[362px] 2xl:w-[416px] object-cover rounded-[16px]">
              <Image
                className="w-full h-[320px] lg:w-[285px] xl:w-[362px] 2xl:w-[416px] object-cover rounded-[16px]"
                src={project.pimage3}
                alt="alt"
                width={546}
                height={320}
