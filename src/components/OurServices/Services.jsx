...
const Services = () => {
  return (
    <div className="h-[1686px} min-w-[375px] lg:h-[652px] mt-[100px] lg:mt-[60px]  ">
      <div className="p-[20px] h-[100px] flex flex-col justify-center text-center items-center  ">
        <h1 className="text-[24px] font-semibold lg:text-[48px] text-[#171717]">
          Our Services
        </h1>
        <p className="text-[14px] lg:text-[16px] text-[#525252] w-[301px] lg:w-[746px]">
      ...
      <div className="relative h-full flex items-center justify-center">
        <div className="relative z-10 grid grid-cols-1   gap-6 md:grid-cols-2 lg:flex  lg:gap-2 xl:gap-8 px-4 py-10 max-w-[1440px] mx-auto ">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-6 mt-[230px] lg:mt-[190px]  ">
                <h1 className="text-[20px] lg:text-[18px] text-white font-bold mb-4 lg:mb-2">
                  {service.title}
                </h1>
                <p className="text-[12px] text-white mb-6">
                  {service.description}
                </p>
              </div>
            </div>
