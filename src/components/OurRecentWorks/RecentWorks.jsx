    ...
    <div className="max-w-[1440px] lg:h-[706px] lg:px-[72px] py-[40px] px-[20px] md:py-[50px] lg:py-[64px] mx-auto">
      <div className="lg:h-[598px]">
        <div className="mx-auto lg:w-[746px] md:h-[122px] text-center">
          ...
          <p className="lg:text-[16px] mt-4 text-[#525252] tracking-wide">
        ...
        <div className="relative h-full lg:h-[454px]   flex items-center justify-center ">
          <div className="relative z-10 grid grid-cols-1  gap-8 md:gap-0 md:grid-cols-2 lg:flex lg:gap-4 xl:gap-10 py-10 max-w-[1440px] mx-auto  w-full">
            {services.map((service, index) => (
              <div
                key={index}
                className="relative w-[335px] lg:w-[415px] mx-auto xl:w-[636px] h-[354px] lg:h-[300px] rounded-3xl overflow-hidden bg-cover bg-center group transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:scale-[1.03] hover:shadow-xl hover:-rotate-1 transform"
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4 z-20 transition-all duration-500 group-hover:translate-y-[-4px]">
                  <p className="text-sm lg:text-[18px] xl:text-[24px]  xl:w-[504px] text-white font-medium">
                    {service.description}
                  </p>
                </div>
